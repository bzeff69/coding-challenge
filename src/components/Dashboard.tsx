  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white dark:bg-stone-900 rounded-2xl shadow-2xl w-full max-w-2xl my-8">
        ...
        <div ref={contentRef} data-print-area={printing || undefined}>
        {/* Print header — only visible when printing */}
        {printing && (
          <div className="px-6 pb-4">
            <h1 className="text-2xl font-black text-stone-900">Streak Dashboard</h1>
        ...
        {/* Print footer */}
        {printing && (
          <div className="px-6 pt-4 text-center text-xs text-stone-300">
            Generated by Streak — Track habits. Get judged.
          </div>
        )}
        </div>
        </div>
